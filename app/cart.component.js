        ...
        execute: function() {
            Cart = (function () {
                function Cart() {
                    ...
                    this.filterCart = true;
                }
                Cart.prototype.onGenreChange = function (filterOption) {
                    this.filterGenre = filterOption;
                };
                Cart.prototype.onArtistChange = function (filterOption) {
                    this.filterArtist = filterOption;
                };
                Cart.prototype.calculateTotal = function (cds) {
                    var total = 0;
